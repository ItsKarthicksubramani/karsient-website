...
export const metadata: Metadata = {
  alternates: { canonical: "/services/databricks-migration" },
          ...
          <Reveal delay={0.1}>
            <div className="mt-12 flex flex-wrap items-center justify-center gap-4 sm:gap-6">
              <div className="flex flex-col items-center gap-2 rounded-2xl border border-ink-line bg-ink px-6 py-4">
                <TechIcon name="greenplum" className="h-10 w-10" />
              ...
              <div className="flex flex-col items-center gap-2 rounded-2xl border border-ink-line bg-ink px-6 py-4">
                ...
                <span className="font-mono text-[10px] uppercase tracking-wide text-signal-bright">
                  ShiftIQ &middot; CodeShift &middot; RevoCode
                </span>
              </div>
              <span className="font-mono text-xl text-signal">&rarr;</span>
              ...
              <span className="font-mono text-xl text-signal">&rarr;</span>
              <div className="flex flex-col items-center gap-2 rounded-2xl border border-ink-line bg-ink px-6 py-4">
                <TechIcon name="powerbi" className="h-10 w-10" />
                <span className="font-body text-sm text-mist">BI / AI / ML</span>
              </div>
            </div>
          </Reveal>
        </div>
