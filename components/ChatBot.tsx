...
function SparkMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className}>
      <path d="M5.5 15c.2 1.6.8 2.5 2.2 2.7-1.4.2-2 1.1-2.2 2.7-.2-1.6-.8-2.5-2.2-2.7 1.4-.2 2-1.1 2.2-2.7Z" fill="#0B0B0B" />
      <path d="M19 3c.2 1.6.8 2.5 2.2 2.7-1.4.2-2 1.1-2.2 2.7-.2-1.6-.8-2.5-2.2-2.7 1.4-.2 2-1.1 2.2-2.7Z" fill="#0B0B0B" />
      <path d="M12 2c.4 3.6 1.9 5.6 5 6-3.1.4-4.6 2.4-5 6-.4-3.6-1.9-5.6-5-6 3.1-.4 4.6-2.4 5-6Z" fill="#fff" />
    </svg>
  );
}
