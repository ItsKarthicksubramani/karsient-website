...
export const techIconMap: Record<LogoKey, (props: IconProps) => JSX.Element> = {
  ...
  iceberg: IconCloudOps,
  sqlserver: IconSQL,
  dataplatform: IconCloudOps,
  netezza: IconCloudOps,
  greenplum: IconCloudOps,
  hadoop: IconCloudOps,
};
...
export const techLabels: Record<LogoKey, string> = {
  ...
  dataplatform: "Cloud Data Platform",
  netezza: "IBM Netezza",
  greenplum: "Greenplum",
...
export const logoImageMap: Partial<Record<LogoKey, { src: string; wide?: boolean; onDark?: boolean }>> = {
  ...
  ai: { src: "/logos/ai-real.svg" },
  oracle: { src: "/logos/oracle.svg", wide: true },
  vectorsearch: { src: "/logos/vectorsearch.png" },
  semanticmodel: { src: "/logos/semanticmodel.png" },
  iceberg: { src: "/logos/iceberg.svg" },
  sqlserver: { src: "/logos/sqlserver.svg" },
  dataplatform: { src: "/logos/dataplatform.png" },
  informatica: { src: "/logos/informatica.svg" },
  netezza: { src: "/logos/netezza.svg" },
  greenplum: { src: "/logos/greenplum.svg" },
  hadoop: { src: "/logos/hadoop.svg" },
};
