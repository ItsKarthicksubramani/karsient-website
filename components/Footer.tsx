  ...
  return (
    <footer className="border-t border-ink-line bg-ink">
      <div className="container-px mx-auto max-w-7xl py-16">
        ...
        <div className="mt-14 flex flex-col gap-6 border-t border-ink-line pt-8 text-sm text-mist sm:flex-row sm:items-center sm:justify-between">
          <p className="font-body">
            &copy; {new Date().getFullYear()} {site.legalName}. All rights
            reserved.
          </p>
          <div className="flex flex-wrap gap-x-6 gap-y-2 font-body">
