...
export async function generateMetadata({
  ...
  if (!cs) return {};
  return { title: cs.title, description: cs.summary, alternates: { canonical: `/case-studies/${slug}` } };
}
    ...
    <>
      <section className="border-b border-ink-line bg-grid-glow">
        <div className="container-px mx-auto max-w-4xl py-24 text-center sm:py-28">
          ...
          <Reveal delay={0.08}>
            <p className="mt-3 font-mono text-[11px] uppercase tracking-[0.2em] text-mist/60">
              Illustrative scenario — representative outcomes, not a specific named client
            </p>
          </Reveal>
          <Reveal delay={0.1}>
