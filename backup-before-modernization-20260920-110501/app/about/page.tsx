    ...
    <>
      ...
      <section className="section-py border-t border-ink-line bg-ink-soft/30">
        <div className="container-px mx-auto max-w-5xl text-center">
          ...
          <Reveal delay={0.1} className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl border border-ink-line bg-ink p-6 text-left">
              <p className="font-mono text-[11px] uppercase tracking-wide text-signal">Headquarters</p>
              <p className="mt-2 font-body text-sm font-semibold text-white">Madurai, India</p>
              <p className="mt-2 font-body text-xs leading-relaxed text-mist">{site.address}</p>
            </div>
            <div className="rounded-xl border border-ink-line bg-ink p-6 text-left">
              <p className="font-mono text-[11px] uppercase tracking-wide text-signal">Technology Hub</p>
              <p className="mt-2 font-body text-sm font-semibold text-white">Bengaluru</p>
              <p className="mt-2 font-body text-xs leading-relaxed text-mist">AI, Data Engineering &amp; Innovation</p>
            </div>
            <div className="rounded-xl border border-ink-line bg-ink p-6 text-left">
              <p className="font-mono text-[11px] uppercase tracking-wide text-signal">Engineering Hub</p>
              <p className="mt-2 font-body text-sm font-semibold text-white">Chennai</p>
              <p className="mt-2 font-body text-xs leading-relaxed text-mist">Data Platforms &amp; Enterprise Engineering</p>
            </div>
            <div className="rounded-xl border border-ink-line bg-ink p-6 text-left">
              <p className="font-mono text-[11px] uppercase tracking-wide text-signal">Global Delivery</p>
              <p className="mt-2 font-body text-sm font-semibold text-white">Worldwide</p>
              <p className="mt-2 font-body text-xs leading-relaxed text-mist">{site.phone} · {site.email}</p>
            </div>
          </Reveal>
        </div>
      </section>
