...
export const services: Service[] = [
  ...
  },
  {
    ...
    short: "Assess, architect, modernize and optimize — across Azure, AWS and Google Cloud.",
    description:
      "We take a modernization-engineering approach to cloud — assessing the current estate, architecting the target state, modernizing applications and data, and optimizing for cost and performance, not just moving workloads.",
    capabilities: [
      "Modernization assessment & target architecture",
      "Secure, well-architected landing zones",
      "Application & data platform modernization",
      "Performance & cost optimization (FinOps)",
    ],
    logos: ["azure", "aws", "googlecloud"],
    tech: ["Microsoft Azure", "AWS", "Google Cloud"],
  },
  {
    slug: "analytics-bi",
    name: "Analytics & BI",
...
export const intelligenceCapabilities = [
  {
    title: "Agentic AI",
    detail: "AI agents that reason, use enterprise tools, execute multi-step workflows, and operate within governed environments.",
    href: "/services/ai-solutions/ai-agents",
  },
  {
    title: "Enterprise RAG",
    detail: "Secure, grounded knowledge systems with retrieval, citations, access control, and evaluation built in.",
    href: "/services/ai-solutions/rag-enterprise-knowledge",
  },
  {
    title: "Generative AI",
    detail: "Production-ready GenAI applications grounded in your enterprise data, not a general-purpose demo.",
    href: "/services/ai-solutions/generative-ai",
  },
  {
    title: "AI/ML",
    detail: "Machine learning platforms, models, deployment, and lifecycle engineering built for production.",
    href: "/services/mlops",
  },
  {
    title: "Intelligent Automation",
    detail: "AI-powered workflows connecting data, systems, and business processes end to end.",
    href: "/services/ai-solutions/agentic-ai-workflows",
  },
];
...
export const heroStats = [
  ...
  },
  {
    value: 7,
    suffix: "+",
    label: "Industry Domains of Team Expertise",
    numeric: true,
  },
  {
    label: "Enterprise-Grade Global Engineering & Delivery",
    numeric: false,
    icon: "globe" as const,
  },
];
...
export const whyKarsient = [
  {
    ...
    detail: "We design the enterprise foundation before building intelligence on top of it.",
  },
  {
    title: "AI + Data Convergence",
    detail: "We connect enterprise data engineering with production AI, not as two separate practices.",
  },
  {
    title: "Production Engineering",
    detail: "We build beyond proof-of-concept toward governed, observable production systems.",
  },
  {
    title: "Platform Agnostic",
    detail: "Deep experience across Databricks, Microsoft Fabric, AWS, Azure, and GCP — we recommend what fits, not what's familiar.",
  },
  {
    title: "Product Mindset",
    detail: "We build reusable platforms, products, and accelerators — not just one-off engagements.",
  },
  {
    title: "Engineering Depth",
    detail: "Our team writes and ships production code alongside yours, not just slide decks and recommendations.",
  },
];

export const engineeringOutcomes = [
  {
    title: "Governed data, faster",
    detail:
      "We design Lakehouse platforms with governance and access control built in from day one — so audits become a formality, not a scramble.",
  },
  {
    title: "Production-first AI",
    detail:
      "Every AI system we build ships with monitoring, evaluation, and human-in-the-loop controls — the same rigor we apply to any production platform.",
  },
  {
    title: "Engineers, not slide decks",
    detail:
      "Our team writes and ships production code alongside yours — architecture decisions are backed by working systems, not just diagrams.",
  },
];
...
export const faqs = [
  {
    ...
    a: "We work primarily with Insurance, Healthcare, Banking & Financial Services, Retail, Manufacturing, Agriculture, and Logistics organisations, bringing enterprise-scale engineering experience to organizations worldwide.",
  },
  {
...
export type SubService = {
  ...
  flow?: string[];
  useCase?: { title: string; scenario: string; approach: string; outcome: string };
};
...
export const aiSolutionsGroup: ServiceGroup = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "RAG is not a chatbot feature — it's an enterprise architecture for grounding AI in trusted organizational knowledge. We build retrieval-augmented generation and enterprise search on top of your documents, databases, and knowledge bases — reducing hallucination and keeping answers traceable back to a source.",
      capabilities: [
      ...
      faqs: [
        {
          q: "Does Karsient build RAG (retrieval-augmented generation) solutions?",
          a: "Yes. Karsient designs and builds enterprise RAG systems end to end — ingestion and chunking of your documents and databases, embeddings and vector search, hybrid (semantic + keyword) retrieval, and grounding LLM answers in your own governed data with citations back to source.",
        },
        {
          q: "How is enterprise RAG different from a simple chatbot?",
          a: "A chatbot answers from a general model's training data. Enterprise RAG grounds every answer in your organization's actual documents and systems, keeps track of access control and data freshness, and is built to be monitored and evaluated in production — not just demoed once.",
        },
        {
          q: "What does Karsient's RAG architecture typically include?",
          a: "Document ingestion and chunking, embeddings, vector search (we work with Pinecone and MongoDB Atlas Vector Search), retrieval and reranking, guardrails and evaluation, and citation/traceability so every answer can be checked against its source.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      flow: ["Understand", "Reason", "Plan", "Act", "Verify"],
      faqs: [
        {
          q: "Does Karsient build Agentic AI solutions?",
          a: "Yes. Karsient designs and builds agentic AI systems — agents that plan, take multi-step actions, and call tools or APIs across your existing systems — with the memory, observability, and human-in-the-loop controls enterprise workflows require.",
        },
        {
          q: "What is Agentic AI, in practical terms?",
          a: "Agentic AI goes beyond a single prompt-and-response: an agent can break a task into steps, decide which tools or APIs to call, retain context across a workflow, and hand off to a human for approval where needed. Karsient designs this at the architecture level — planning, tool integration, memory, and failure handling — not just the model prompt.",
        },
        {
          q: "How does Karsient handle governance and safety for AI agents?",
          a: "Every agentic system we build includes observability (so you can see what an agent did and why), human-in-the-loop approval for consequential actions, and audit trails — the same production rigor we apply to any enterprise system, not an afterthought bolted on later.",
        },
      ],
    },
    {
  ...
  items: [
    {
      ...
      description:
        "We design and build data engineering pipelines, semantic models, and reporting on Microsoft Fabric — for organisations standardising on the Microsoft data stack. Our support spans the full lifecycle: an initial assessment of your current Power BI/Synapse/Azure estate, a phased build-out of Lakehouse and Warehouse items in Fabric, migration of existing pipelines, and ongoing capacity and cost management once you're live — either handed back to your team or continued as a managed engagement.",
      capabilities: [
        ...
        "Migration from Synapse / Azure Data Factory",
      ],
      techLogos: ["fabric", "powerbi"],
      useCase: {
        title: "Consolidating Synapse and Power BI into one Fabric estate",
        scenario:
          "An organisation running Azure Synapse for warehousing and a separate Power BI/Azure Data Factory setup for reporting, with duplicated pipelines and inconsistent semantic models across teams.",
        approach:
          "We assessed the existing Synapse and ADF estate, designed a single Fabric Lakehouse and Warehouse architecture, rebuilt pipelines as Dataflow Gen2 items, and consolidated reporting onto shared semantic models.",
        outcome:
          "One governed Fabric workspace replacing multiple disconnected tools, with a single semantic layer for Power BI reporting.",
      },
    },
    {
      slug: "snowflake",
      ...
      description:
        "For organisations running or extending a Snowflake estate, we build ELT pipelines, data models, and governance on Snowflake itself — not every Snowflake engagement is a migration. Support ranges from a scoped build (new pipelines, models, or a governance layer) to an ongoing engineering partnership covering performance tuning, credit-usage optimisation, and ongoing pipeline development as your estate grows.",
      capabilities: [
      ...
      useCase: {
        title: "Cutting Snowflake credit spend while unblocking new pipeline requests",
        scenario:
          "A Snowflake estate that had grown organically over several years — warehouses sized once and never revisited, and a backlog of new pipeline requests the existing team couldn't get to.",
        approach:
          "We audited warehouse sizing and query patterns against actual usage, right-sized and split workloads by warehouse, and took on the backlog of new ELT pipelines and dbt models as an ongoing engineering partnership.",
        outcome:
          "Lower credit consumption from right-sized warehouses, and a cleared pipeline backlog without the client needing to hire additional headcount.",
      },
    },
    {
      ...
      description:
        "ERP systems like SAP hold the transactional core of the business, but they're rarely built for analytics. We build extraction and transformation pipelines that get ERP data into your analytics estate reliably and on schedule — starting with an assessment of source tables and business objects, then building change-data-capture pipelines, business-object modelling for finance and operations, and reconciliation checks against the ERP source of truth. Support continues as a managed pipeline operation, or handed back to your team with documentation.",
      capabilities: [
      ...
      techLogos: ["sap"],
      useCase: {
        title: "Getting finance a daily, reconciled view out of SAP",
        scenario:
          "A finance team relying on manually exported SAP reports for month-end close, with no automated, reconciled feed of financial data into the analytics estate.",
        approach:
          "We built change-data-capture pipelines against the relevant SAP source tables, modelled the extracted data into finance-ready business objects, and added reconciliation checks back against SAP as the source of truth.",
        outcome:
          "A daily, automatically reconciled finance dataset replacing manual exports, with discrepancies flagged before month-end close rather than during it.",
      },
    },
    {
      ...
      description:
        "We implement the data quality checks, cataloguing, and access governance that make a data platform something the business can actually trust — not just query. On Databricks estates this centres on Unity Catalog for cataloguing, lineage, and access policy; alongside it, our Karsient Veriq product continuously monitors data quality and flags issues before they reach downstream reports, rather than being discovered by an analyst after the fact.",
      capabilities: [
        "Automated data quality rules & monitoring with Karsient Veriq",
      ...
      useCase: {
        title: "Catching data quality issues before they reach a dashboard",
        scenario:
          "A governed Databricks estate with Unity Catalog access policies in place, but no automated way to catch schema drift or bad records before they landed in gold-layer tables feeding executive dashboards.",
        approach:
          "We layered Karsient Veriq on top of the existing Unity Catalog setup — defining quality rules per table, flagging anomalies at ingestion, and routing failures for review before promotion to the gold layer.",
        outcome:
          "Data quality issues are now caught and quarantined before they reach a report, instead of being found after the fact.",
      },
    },
  ],
};
...
const standardMethodology = [
  { step: "Discovery", detail: "Understand business goals, current systems, and constraints — accelerated with Karsient ShiftIQ." },
  { step: "Assessment", detail: "Inventory databases, tables, pipelines, workloads, dependencies and usage using Karsient ShiftIQ." },
  ...
  { step: "Migration", detail: "Move data, SQL, transformations and pipelines in planned, testable phases with Karsient RevoCode." },
  { step: "Engineering", detail: "Build and re-engineer pipelines, jobs, and integrations using Karsient RevoCode." },
...
export const products: Product[] = [
  {
    ...
    integrations: ["talend", "vertica", "oracle", "informatica", "ssis", "teradata", "sql", "sqlserver", "databricks", "snowflake", "fabric", "azure", "aws", "googlecloud"],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["talend", "vertica", "oracle", "informatica", "databricks", "deltalake", "python", "snowflake", "fabric", "azure", "aws", "googlecloud"],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["databricks", "deltalake", "python", "sql", "cloudops", "azuremonitor", "snowflake", "fabric", "azure", "aws", "googlecloud"],
    faqs: [
  ...
  },
  {
    ...
    integrations: ["databricks", "snowflake", "fabric", "azure", "aws", "googlecloud", "spark", "kafka", "sql", "dbt", "airflow"],
    faqs: [
